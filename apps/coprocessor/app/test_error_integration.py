...
from .error_handling import ErrorHandler, handle_service_exception
from .services.url_parser import URLParserError, ShareURLParser
from .services.asr_service import ASRError, ASRService
from .services.llm_service import LLMError, DeepSeekAdapter
from .services.file_handler import FileHandlerError, FileHandler
from .services.oss_uploader import OSSUploaderError, OSSUploader
        ...
        with patch.dict('os.environ', {'DASHSCOPE_API_KEY': 'test_key'}):
            ...
            with patch('dashscope.audio.asr.Transcription.async_call') as mock_call:
                ...
                with pytest.raises(ASRError):
                    import asyncio
                    asyncio.run(asr_service.transcribe_from_url("http://example.com/video.mp4"))
